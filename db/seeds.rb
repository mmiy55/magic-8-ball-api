...
answer4 = Answer.create(content: "Sure thing", answer_type:"positive", ball: default_ball)
answer5 = Answer.create(content: "Better forget about it", answer_type:"negative", ball: default_ball)
answer6 = Answer.create(content: "Follow your heart", answer_type:"vague", ball: default_ball)
